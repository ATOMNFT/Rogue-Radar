...
//#include <User_Setup_TEST.h>                     // (TEST SETUP FOR 3.5in CYD R)

//----------------------------------------------------------------------------------------
//#include <User_Setup_JCMK.h>                     // (Generic Setup by JustCallMeKoKo)
//#include <User_Setup_JCMK_cyd_micro.h>           // (CYD Micro Setup by JustCallMeKoKo)
//#include <User_Setup_JCMK_cyd_2usb.h>            // (CYD2USB Setup by JustCallMeKoKo)
//----------------------------------------------------------------------------------------

//################################### CYD SETUPS ##############################################
//#include <User_Setup_CYD.h>                      // (For CYD)
//#include <User_Setup_CYD2USB.h>                  // (For CYD2USB)
//#include <User_Setup_cyd_Micro.h>                // (For CYD) Aux
//#include <User_Setup_nm_cyd_c5.h>                // (For NM-CYD)
//################################### 2.8in MARAUDER SETUPS ###################################
//#include <User_Setup_CYD_Micro4Marauder.h>       // (For CYD Micro USB & Newest Marauder)
//#include <User_Setup_CYD_2USB4Marauder.h>        // (For CYD 2USB & Newest Marauder)
//################################### END MARAUDER SETUPS #####################################
//------------------------------------ CYD 3.5 -----------------------------------------
//#include <User_Setup_CYD35.h>                    // (For CYD 3.5in)
//#include <User_Setup_CYD35-Capacitive.h>         // (For CYD 3.5in Cap Touch) From User ShadowTrance
//#include <User_Setup_CYD35-Capacitive-JCMK.h>    // (For CYD 3.5in Cap Touch) From User JustCallMeKoko
//#include <User_Setup_CYD35_ILI9488.h>            // (For CYD 3.5in)
//------------------------------------ CYD GUITION -----------------------------------------
//#include <User_Setup_CYD24_Guition.h>            // (For CYD Guition)
//#include <User_Setup_CYD24_Cap.h>                // (For CYD Capacitive Guition)
//#include <User_Setup_CYD28_Guition_Capacitive.h> // (For CYD JC2432W328C Capacitive Guition)
//#include <User_Setup_CYD_LVGL.h>                 // (For CYD with LVGL)
//#include <User_Setup_Fancygotchi_CYD.h>          // (For CYD running fancygotchi port)
//################################### END CYD SETUPS #########################################
...
//################################### Misc ESP32 SETUPS ######################################
//#include <User_Setup_ESP32-C3-MINI.h>            // (For ESP32-C3-SuperMini With ST7789 240x240 Display)
//#include <User_Setup_ESP32-S2-MINI.h>            // (For ESP32-S2-Mini Purple)
//################################# END MISC ESP32 SETUPS ####################################
